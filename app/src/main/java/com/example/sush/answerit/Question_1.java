...
public class Question_1 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Number.equals("1")||Number.equals("2")||Number.equals("3")||Number.equals("4")) {
                   ...
                   if(GoForIt.j==9)
                   {
                       Intent intent = new Intent(Question_1.this,ResultPage.class);
                ...
                else if(Number.equals("Empty"))
                {
                    ...
                    Toast.makeText(Question_1.this, "Select an option", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        alert = new AlertDialog.Builder(Question_1.this);
        ...
        alert.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(Question_1.this,GoForIt.class);
                startActivity(intent);
